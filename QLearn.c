...
void
QLearn_update (int s, int a, double r, int s_new, double *QTable)
{
  /*
...
int
QLearn_action (double gr[max_graph_size][4], int mouse_pos[1][2],
...
void
feat_QLearn_update (double gr[max_graph_size][4], double weights[25],
...
int
feat_QLearn_action (double gr[max_graph_size][4], double weights[25],
...
void
evaluateFeatures (double gr[max_graph_size][4], double features[25],
                  int mouse_pos[1][2], int cats[5][2], int cheeses[5][2],
                  int size_X, int graph_size)
{
  /*
...
void
maxQsa (double gr[max_graph_size][4], double weights[25], int mouse_pos[1][2],
        int cats[5][2], int cheeses[5][2], int size_X, int graph_size,
                             ...
                             int graph_size)
{
  ...
  int ra = rand () % 101;
  return 1 - (man_dis / ((double)size_X * 2));
}
